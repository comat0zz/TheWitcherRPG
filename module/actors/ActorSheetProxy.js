...
import { MonsterActorSheet } from "./sheets/MonsterActorSheet.js";
import { MountActorSheet } from "./sheets/MountActorSheet.js";


const itemSheetMappings = {
  hero: HeroActorSheet, 
  npc: NpcActorSheet, 
  monster: MonsterActorSheet, 
  mount: MountActorSheet
}
 ...
 */
 export const WitcherActorSheetProxy = new Proxy(function () {}, {
